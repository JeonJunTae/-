...
{ 
  ...
  loadVoltage = 2 * sensorValue * (5.0 / 1023.0);
  ...
  Serial.print("Current:       "); Serial.print(ActualCurrent); Serial.println(" mA");
  Serial.print("Voltage:       "); Serial.print(loadVoltage); Serial.println(" V");
  Serial.print("Power:       "); Serial.print(ActualPower); Serial.println(" W");
  Serial.print("Load:       "); Serial.print(loadVoltage/(ActualCurrent/1000)); Serial.println(" ohm");
  Serial.print("Control -> dac_Vref:         "); Serial.println(dac_Vref);
  Serial.print("setCurrent:  "); Serial.println(String(setCurrent)+"mA");
  Serial.print("setPower:  "); Serial.println(String(setPower)+"W");
  Serial.print("setResistance:  "); Serial.println(String(setResistance)+"ohm");
  ...
  */
  ...
  if(loadVoltage > 1)
  {
    ...
    { 
      if(ActualCurrent <= MAX_CURRENT && loadVoltage <= MAX_VOLTAGE && ActualPower <= MAX_POWER)
      {
        if(upvalue == HIGH)
        {
